...
class DriverFactory {
    ...
    public function __construct(array $config) {
        ...
        foreach ($this->config["drivers"] as $driver) {
            require_once __DIR__ . DIRECTORY_SEPARATOR . "Driver" . DIRECTORY_SEPARATOR . $driver . DIRECTORY_SEPARATOR . "Driver.php";
     ...
     */
    public function getDriverForSource(array $source) : DriverInterface {
